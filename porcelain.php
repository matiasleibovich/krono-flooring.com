...
?>
    ...
    <main id="site-container">
        ...
        <div class="page-title-container">
            ...
            <div id="page-title-text"><h1><?=$dict[$_SESSION['language']]['title_porcelain_floors']?></h1></div>
        </div>
        <!-- PAGE CONTAINER -->
    ...
    <script type="text/javascript">
        jQuery(document).ready(function () {
            ...
            if (jQuery(window).width() > 480) {
                jQuery('.page-title-container').backstretch("images/photos/flooring_porcelain_1.jpg");
            }
        });
    </script>
    <!-- POST IMAGE LOOP -->
